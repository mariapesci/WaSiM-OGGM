...
This script performs the automatic calibration of WaSiM parameters, during the third run 
of the couopling scheme. This script calls the settings defined in 'spotpy_coupling_settings.py'.
...
# Define the settings from 'spotpy_coupling_settings.py'
...
class spotpy_setup():
    ...
    def objectivefunction(self, simulation, evaluation, params=None):
        ...
        # Adjust time series in case they have different lengths
...
# Run spotpy (required: observed runoff, OGGM glacier mass balance and period of calibration)
...
# Read the results and plot the n° iterations vs. the objective function, to see if the model converges
results_spotpy = np.genfromtxt(r'E:\DIRT_X\Gepatsch\Coupling\spotpy_cal\wasim_coupling\cal_coup_init_1969.csv', delimiter=',', usecols=0)
